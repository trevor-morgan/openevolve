...
module attributes {torch.debug_module_name = "SelfAttention"} {
  ...
  func.func @forward(%arg0: tensor<1x16x64xf32>) -> tensor<1x16x64xf32> {
    ...
    %cst_0 = arith.constant dense<"0001213131"> : tensor<64x64xf32>
    ...
    %cst_2 = arith.constant dense<"0001213131"> : tensor<64x64xf32>
    ...
    %cst_4 = arith.constant dense<"0001213131"> : tensor<64x64xf32>
    ...
    %cst_6 = arith.constant dense<"0001213131"> : tensor<64x64xf32>
